...
import '../../Css/Reducer/reducerApi.css'
...
function ReducerApi() {
    ...
    return (
        // <div>ReducerApi</div>
        <>
            <form action="" className='stdform mx-auto  p-3 border border-1 reducer-crud'>
                ...
                <button type="button" className="save_button btn btn-success mt-4" onClick={() => saveData()}>Submit</button><br /><br /><br />
            </form><br />

            <table className='stdtable2 table text-center w-100'>
                <thead className=''>
                    <th>ID</th>
                    <th>First Name</th>
                    <th>Last Name</th>
